...
cd /opt/project/deployed
nohup java -jar multidbsfilesapis2dbsserverapi-0.1-SNAPSHOT.jar /opt/project/MultiDBs-FilesAPIs2DBs-Server/MultiDBsFilesAPIs2DBsServerAPI/src/main/resources/config.properties > log.out 2> error.log < /dev/null &
